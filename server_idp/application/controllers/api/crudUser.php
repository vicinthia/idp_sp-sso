...
class crudUser extends REST_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('crudUser_model', 'ticket');
    }
    ...
    public function index_post()
    {
        ...
        $id_user = $this->ticket->insert_id($data);

        redirect('ssoClients/create_applicationMahasiswa/'.$id_user);
    ...
    public function index_put()
    {
        ...
        $data = [
            ...
            'refresh_token' => $this->put('refresh_token'),
        ];
