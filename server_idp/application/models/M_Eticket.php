...
class M_Eticket extends CI_Model
{
    ...
    ////// MODEL BUAT NAMPILIN TRANSAKSI PERBULAN AJA ///////
     ...
     {
         $query = $this->db->query("select*from transaksi where tgl <= '2022-01-31' and tgl >= '2022-01-01'");
         return $query->result();
     }
     public function get_sumJan()
     {
         $this->db->select_sum('total');
         $this->db->from("transaksi where tgl <= '2022-01-32' and tgl >= '2022-01-01'");
         return $this->db->get('')->row();
     }
     public function get_summejaJan()
     {
         $this->db->select_sum('meja');
         $this->db->from("transaksi where tgl <= '2022-01-31' and tgl >= '2022-01-01'");
         return $this->db->get('')->row();
     }
     ...
     {
         $query = $this->db->query("select*from transaksi where tgl <= '2022-02-28' and tgl >= '2022-02-01'");
         return $query->result();
     }
     public function get_sumFeb()
     {
         $this->db->select_sum('total');
         $this->db->from("transaksi where tgl <= '2022-02-29' and tgl >= '2022-02-01'");
         return $this->db->get('')->row();
     }
     public function get_summejaFeb()
     {
         $this->db->select_sum('meja');
         $this->db->from("transaksi where tgl <= '2022-02-28' and tgl >= '2022-02-01'");
         return $this->db->get('')->row();
     }
     ...
     {
         $query = $this->db->query("select*from transaksi where tgl <= '2022-03-31' and tgl >= '2022-03-01'");
         return $query->result();
     }
     public function get_sumMar()
     {
         $this->db->select_sum('total');
         $this->db->from("transaksi where tgl <= '2022-03-32' and tgl >= '2022-03-01'");
         return $this->db->get('')->row();
     }
     public function get_summejaMar()
     {
         $this->db->select_sum('meja');
         $this->db->from("transaksi where tgl <= '2022-03-31' and tgl >= '2022-03-01'");
         return $this->db->get('')->row();
     }
     ...
     {
         $query = $this->db->query("select*from transaksi where tgl <= '2022-04-30' and tgl >= '2022-04-01'");
         return $query->result();
     }
     public function get_sumApr()
     {
         $this->db->select_sum('total');
         $this->db->from("transaksi where tgl <= '2022-04-31' and tgl >= '2022-04-01'");
         return $this->db->get('')->row();
     }
     public function get_summejaApr()
     {
         $this->db->select_sum('meja');
         $this->db->from("transaksi where tgl <= '2022-04-30' and tgl >= '2022-04-01'");
         return $this->db->get('')->row();
     }
     ...
     {
         $query = $this->db->query("select*from transaksi where tgl <= '2022-05-31' and tgl >= '2022-05-01'");
         return $query->result();
     }
     public function get_sumMei()
     {
         $this->db->select_sum('total');
         $this->db->from("transaksi where tgl <= '2022-05-32' and tgl >= '2022-05-01'");
         return $this->db->get('')->row();
     }
     public function get_summejaMei()
     {
         $this->db->select_sum('meja');
         $this->db->from("transaksi where tgl <= '2022-05-31' and tgl >= '2022-05-01'");
         return $this->db->get('')->row();
     }
     ...
     {
         $query = $this->db->query("select*from transaksi where tgl <= '2022-06-30' and tgl >= '2022-06-01'");
         return $query->result();
     }
     public function get_sumJun()
     {
         $this->db->select_sum('total');
         $this->db->from("transaksi where tgl <= '2022-06-31' and tgl >= '2022-06-01'");
         return $this->db->get('')->row();
     }
     public function get_summejaJun()
     {
         $this->db->select_sum('meja');
         $this->db->from("transaksi where tgl <= '2022-06-30' and tgl >= '2022-06-01'");
         return $this->db->get('')->row();
     }
