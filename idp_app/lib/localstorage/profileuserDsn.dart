...
import 'package:idp_app/localstorage/updateprofileDsn.dart';
...
class profileUserDsn extends StatefulWidget {
  @override
  _profileUserDsnState createState() => _profileUserDsnState();
}

class _profileUserDsnState extends State<profileUserDsn> {
  File _image;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => dosenPage()));
          },
                    ...
                    setState(() {
                      setState(() {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => updateProfileDsn(
            ...
            ProfileMenuWidget(
              ...
              onPress: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => dataProfileDsn()));
              },
            ),
            Divider(
              color: Colors.grey,
                ...
                await CoolAlert.show(
                    ...
                    onCancelBtnTap: () async {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => profileUserDsn()),
                      );
                    });
              },
            ),
