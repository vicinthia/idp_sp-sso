...
import 'package:idp_app/localstorage/biodataAdmin.dart';
...
import 'package:idp_app/localstorage/updateprofileAdmin.dart';
...
class profileUserAdmin extends StatefulWidget {
  @override
  _profileUserAdminState createState() => _profileUserAdminState();
}

class _profileUserAdminState extends State<profileUserAdmin> {
  File _image;
                    ...
                    setState(() {
                      setState(() {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => updateProfileAdmin(
            ...
            ProfileMenuWidget(
                ...
                onPress: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => dataProfileAdmin()));
                }),
            Divider(
              color: Colors.grey,
            ),
                ...
                await CoolAlert.show(
                    ...
                    onCancelBtnTap: () async {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => profileUserAdmin()),
                      );
                    });
              },
            ),
