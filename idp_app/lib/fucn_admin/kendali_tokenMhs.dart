...
class kendaliTokenMhs extends StatefulWidget {
  const kendaliTokenMhs({Key key}) : super(key: key);

  @override
  State<kendaliTokenMhs> createState() => _kendaliTokenMhsState();
}

class _kendaliTokenMhsState extends State<kendaliTokenMhs> {
  String Harga;
              ...
              FutureBuilder<List>(
                ...
                builder: (context, snapshot) {
                  ...
                  return snapshot.hasData
                      ? Text("Kelola Akun Token User Mahasiswa",
                          style: TextStyle(
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        "Nama Mahasiswa : ${snapshot.data[i]['name']}",
                                                        style: TextStyle(
                                                            fontSize: 16,
                                                            fontWeight:
                                                                FontWeight
