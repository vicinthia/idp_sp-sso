...
import 'package:idp_app/fucn_admin/karyawan/list_userkryn.dart';
...
class editUserKryn extends StatefulWidget {
  ...
  editUserKryn(
      ...
      this.user});
  @override
  _editUserKrynState createState() => _editUserKrynState();
}

class _editUserKrynState extends State<editUserKryn> {
  File _image;
