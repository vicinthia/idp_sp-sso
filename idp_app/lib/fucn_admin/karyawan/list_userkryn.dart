...
import 'package:idp_app/fucn_admin/karyawan/edit_userKryn.dart';
import 'package:idp_app/model/m_editprofile.dart';

import '../../api/link.dart';

class adminKryn extends StatefulWidget {
  @override
  State<adminKryn> createState() => _adminKrynState();
}

class _adminKrynState extends State<adminKryn> {
        ...
        title: Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                hintText: "Cari User by Username"),
          ),
        ),
        leading: IconButton(
                    ...
                    return filter == null || filter == ""
                        ? Slidable(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text(
                                  "Jabatan :" + snapshot.data[i]['no_induk'],
                                  style: TextStyle(
                                    fontSize: 16,
                                  )),
