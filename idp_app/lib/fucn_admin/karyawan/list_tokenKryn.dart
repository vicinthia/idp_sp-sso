...
class adminTokenKrywn extends StatefulWidget {
  const adminTokenKrywn({Key key}) : super(key: key);

  @override
  State<adminTokenKrywn> createState() => _adminTokenKrywnState();
}

class _adminTokenKrywnState extends State<adminTokenKrywn> {
  String Harga;
