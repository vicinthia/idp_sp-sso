...
import 'edit_userDsn.dart';

class adminDsn extends StatefulWidget {
  @override
  State<adminDsn> createState() => _adminDsnState();
}

class _adminDsnState extends State<adminDsn> {
                    ...
                    return filter == null || filter == ""
                        ? Slidable(
                            ...
                            child: ListTile(
                              ...
                              subtitle:
                                  Text("NIDN :" + snapshot.data[i]['no_induk'],
                                      style: TextStyle(
                                        fontSize: 16,
                                      )),
