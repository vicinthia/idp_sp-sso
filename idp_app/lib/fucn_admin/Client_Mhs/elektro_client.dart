...
import 'select_elektroClient.dart';

class allMhsElektro extends StatefulWidget {
  @override
  State<allMhsElektro> createState() => _allMhsElektroState();
}

class _allMhsElektroState extends State<allMhsElektro> {
  ...
  Future<List<MenuModel>> fetchMenuModels() async {
    var response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/func_admin/ClientLevel/index?level=Mahasiswa&&jurusan=Teknik Elektronika"));
