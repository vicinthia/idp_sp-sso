...
class selectMhsInfor extends StatefulWidget {
  String menuName;
  selectMhsInfor({this.menuName});
  @override
  State<selectMhsInfor> createState() => _selectMhsInforState();
}

class _selectMhsInforState extends State<selectMhsInfor> {
  ...
  Future<List<MenuModel>> fetchMenuMakanan() async {
    var response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/func_admin/Mhs_Nim/listbynim?level=Mahasiswa&&no_induk=${widget.menuName}&&jurusan=Teknik Informatika"));
