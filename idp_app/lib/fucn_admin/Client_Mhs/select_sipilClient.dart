...
class selectMhsSipil extends StatefulWidget {
  String menuName;
  selectMhsSipil({this.menuName});
  @override
  State<selectMhsSipil> createState() => _selectMhsSipilState();
}

class _selectMhsSipilState extends State<selectMhsSipil> {
  ...
  Future<List<MenuModel>> fetchMenuMakanan() async {
    var response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/func_admin/Mhs_Nim/listbynim?level=Mahasiswa&&no_induk=${widget.menuName}&&jurusan=Teknik Sipil"));
          ...
          title: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: "Cari NIM Mahasiswa Sipil"),
            ),
          ),
        ),
        body: Padding(
                        ...
                        onChanged: (String newValue) {
                          setState(() {
                            ...
                            Navigator.of(context).pushReplacement(
                                MaterialPageRoute(
                                    builder: (context) =>
                                        selectMhsSipil(menuName: daftar)));
                            setState(() {});
                          });
                        },
                        items: semesterList
