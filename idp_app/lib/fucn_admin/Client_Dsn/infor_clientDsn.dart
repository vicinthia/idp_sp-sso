...
// class allDsnInfor extends StatefulWidget {
//   @override
//   State<allDsnInfor> createState() => _allDsnInforState();
// }

// class _allDsnInforState extends State<allDsnInfor> {
...
//         "api/func_admin/clientLevel?level=Dosen&&jurusan=Teknik Informatika"));
...
//                   hintText: "Cari NIDN Dosen Informatika"),
//             ),
//           ),
//         ),
//         body: Padding(
...
import 'package:idp_app/fucn_admin/Client_Dsn/pop_inforDsn.dart';
import 'package:idp_app/fucn_admin/Client_Mhs/select_inforClient.dart';
...
class _allDsnInforState extends State<allDsnInfor> {
  ...
  Future<List<MenuModel>> fetchMenuModels() async {
    var response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/func_admin/ClientLevel/index?level=Dosen&&jurusan=Teknik Informatika"));
    return (json.decode(response.body)['data'] as List)
        .map((e) => MenuModel.fromJson(e))
        .toList();
  }
