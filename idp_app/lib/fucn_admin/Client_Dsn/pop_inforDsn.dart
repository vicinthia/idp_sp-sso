...
import 'package:idp_app/fucn_admin/Client_Dsn/infor_clientDsn.dart';
...
class LockDialogInfor extends StatefulWidget {
  ...
  @override
  _LockDialogInforState createState() => _LockDialogInforState();
}

class _LockDialogInforState extends State<LockDialogInfor> {
  int columnCount = 1;
  int itemsPerColumn;
  ...
  Future<void> unlockedClientsSSODsn(String namesAPP) async {
    switch (namesAPP) {
      case 'Sistem Informasi Manajemen':
        ...
        break;
      case 'Lab Teknik Informatika':
        unLockedClients = "Lab Teknik Informatika";
        unImageClients = "lab_ti";
        unlockedApp(namesAPP);
        break;
