...
class allDsnElektro extends StatefulWidget {
  @override
  State<allDsnElektro> createState() => _allDsnElektroState();
}

class _allDsnElektroState extends State<allDsnElektro> {
  ...
  Future<List<MenuModel>> fetchMenuModels() async {
    var response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/func_admin/ClientLevel/index?level=Dosen&&jurusan=Teknik Elektronika"));
          ...
          title: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintText: "Cari NIDN Dosen Elektronika"),
            ),
          ),
        ),
        body: Padding(
