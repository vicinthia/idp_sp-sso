...
class allKrynElektro extends StatefulWidget {
  @override
  State<allKrynElektro> createState() => _allKrynElektroState();
}

class _allKrynElektroState extends State<allKrynElektro> {
  ...
  Future<List<MenuModel>> fetchMenuModels() async {
    var response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/func_admin/ClientLevel/index?level=Karyawan&&jurusan=Teknik Elektronika"));
