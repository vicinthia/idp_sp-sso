...
class allKrynSipil extends StatefulWidget {
  @override
  State<allKrynSipil> createState() => _allKrynSipilState();
}

class _allKrynSipilState extends State<allKrynSipil> {
  ...
  Future<List<MenuModel>> fetchMenuModels() async {
    var response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/func_admin/ClientLevel/index?level=Karyawan&&jurusan=Teknik Sipil"));
