...
import 'package:idp_app/fucn_admin/karyawan/brnd_ClientKryn.dart';
import 'package:idp_app/fucn_admin/karyawan/list_tokenKryn.dart';
...
import '../fucn_admin/karyawan/kendali_tokenKryn.dart';
import '../fucn_admin/karyawan/list_userkryn.dart';
import '../fucn_admin/kendali_tokenMhs.dart';

class brndAdminKryn extends StatefulWidget {
  const brndAdminKryn({Key key}) : super(key: key);

  @override
  State<brndAdminKryn> createState() => _brndAdminKrynState();
}

class _brndAdminKrynState extends State<brndAdminKryn> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 0, 83, 192),
        title: Text("Management User Karyawan",
            style: TextStyle(
                color: Colors.white,
                fontSize: 16,
      ...
      children: [
          ...
          child: InkWell(
            onTap: () {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => adminKryn()),
              );
            },
        ...
        StaggeredGridTile.count(
          ...
          child: InkWell(
            onTap: () {
              // Handle tile press here
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => adminTokenKrywn()),
              );
            },
            child: TaskGroupContainer(
              color: Colors.orange,
        ...
        StaggeredGridTile.count(
          ...
          child: InkWell(
            onTap: () {
              // Handle tile press here
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => kendaliTokenKryn()),
              );
            },
            child: TaskGroupContainer(
              color: Colors.green,
        ...
        StaggeredGridTile.count(
          ...
          child: InkWell(
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => brndClientKryn()),
              );
            },
            child: TaskGroupContainer(
              color: Colors.blue,
