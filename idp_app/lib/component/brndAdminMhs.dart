...
import '../fucn_admin/brnd_ClientMhs.dart';
import '../fucn_admin/kendali_tokenMhs.dart';

class brndAdminMhs extends StatefulWidget {
  const brndAdminMhs({Key key}) : super(key: key);

  @override
  State<brndAdminMhs> createState() => _brndAdminMhsState();
}

class _brndAdminMhsState extends State<brndAdminMhs> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 0, 83, 192),
        title: Text("Management User Mahasiswa",
            style: TextStyle(
                color: Colors.white,
                fontSize: 16,
      ...
      children: [
        ...
        StaggeredGridTile.count(
          ...
          child: InkWell(
            onTap: () {
              // Handle tile press here
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => adminTokenMhs()),
              );
            },
            child: TaskGroupContainer(
              color: Colors.orange,
        ...
        StaggeredGridTile.count(
          ...
          child: InkWell(
            onTap: () {
              // Handle tile press here
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => kendaliTokenMhs()),
              );
            },
            child: TaskGroupContainer(
              color: Colors.green,
        ...
        StaggeredGridTile.count(
          ...
          child: InkWell(
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => brndClientMhs()),
              );
            },
            child: TaskGroupContainer(
              color: Colors.blue,
              ...
              // taskCount: 9,
              taskGroup: "Client SSO Mahasiswa",
            ),
          ),
        ),
      ],
