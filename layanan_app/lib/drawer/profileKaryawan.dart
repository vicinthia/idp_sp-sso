...
class dataProfileKaryawan extends StatefulWidget {
  @override
  _dataProfileKaryawanState createState() => _dataProfileKaryawanState();
}

class _dataProfileKaryawanState extends State<dataProfileKaryawan> {
  @override
  void initState() {
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          enabled: false,
                          controller: TextEditingController(
                              text: userModel.userInduk ?? 'No Jabatan'),
                          decoration: InputDecoration(
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(100),
                            ),
