...
import 'package:layanan_app/model/dosen_model/simDsn_model.dart';
...
class simDsn extends StatefulWidget {
  final status;
  simDsn({this.status});

  @override
  State<simDsn> createState() => _simDsnState();
}

class _simDsnState extends State<simDsn> {
  @override
  void initState() {
    super.initState();
    _loadReceivedData();
...
//Token dari IdP kemudian dikirimkan ke URL Domain SP App SIM lewat Header Authorization baerer<token>
  ...
  Container _menuItems(simDsnModel simDsnModel) {
    return Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.asset(
              'assets/menuImage/${simDsnModel.image}',
              width: 110,
              height: 110,
            ),
          ),
