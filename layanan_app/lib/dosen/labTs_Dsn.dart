...
import 'package:layanan_app/model/dosen_model/labTsDsn_model.dart';
...
class labTSDsn extends StatefulWidget {
  @override
  State<labTSDsn> createState() => _labTSDsnState();
}

class _labTSDsnState extends State<labTSDsn> {
  @override
  void initState() {
    super.initState();
    _loadReceivedData();
  ...
  Container _menuItems(labTsDsnModel labTsDsnModel) {
    return Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.asset(
              'assets/menuImage/${labTsDsnModel.image}',
              width: 110,
              height: 110,
            ),
          ),
          ...
          Flexible(
            ...
            child: Column(
              ...
              children: [
                ...
                RichText(
                    text: TextSpan(
                        text: "Layanan: ${labTsDsnModel.ket}",
                        style: GoogleFonts.manrope(
