...
import 'package:layanan_app/model/dosen_model/labTiDsn_model.dart';
...
class labTIDsn extends StatefulWidget {
  @override
  State<labTIDsn> createState() => _labTIDsnState();
}

class _labTIDsnState extends State<labTIDsn> {
  @override
  void initState() {
    super.initState();
    _loadReceivedData();
  ...
  ListView _menuItem() {
    return ListView.separated(
        ...
        shrinkWrap: true,
        itemBuilder: (context, index) => _menuItems(menuLabTi[index]),
  ...
  Container _menuItems(labTiDsnModel labTiDsnModel) {
    return Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.asset(
              'assets/labFitur_Image/${labTiDsnModel.image}',
              width: 110,
              height: 110,
            ),
          ),
          ...
          Flexible(
            ...
            child: Column(
              ...
              children: [
                ...
                RichText(
                    text: TextSpan(
                        text: "Layanan: ${labTiDsnModel.ket}",
                        style: GoogleFonts.manrope(
