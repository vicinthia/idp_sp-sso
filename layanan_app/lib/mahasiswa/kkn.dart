...
import 'package:layanan_app/model/kkn_model.dart';
...
class kknMhs extends StatefulWidget {
  @override
  State<kknMhs> createState() => _kknMhsState();
}

class _kknMhsState extends State<kknMhs> {
  @override
  void initState() {
    super.initState();
    _loadReceivedData();
  ...
  Container _menuItems(kknModel kknModel) {
    return Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.asset(
              'assets/kknFitur_Image/${kknModel.image}',
              width: 110,
              height: 110,
            ),
          ),
