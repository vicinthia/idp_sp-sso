...
import 'package:layanan_app/model/labte_model.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

var selectedService = 0;

class labTEMhs extends StatefulWidget {
  @override
  State<labTEMhs> createState() => _labTEMhsState();
}

class _labTEMhsState extends State<labTEMhs> {
  @override
  void initState() {
    super.initState();
    _loadReceivedData();
  ...
  Container _menuItems(labTeModel labTeModel) {
    return Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.asset(
              'assets/labFitur_Image/${labTeModel.image}',
              width: 110,
              height: 110,
            ),
          ),
