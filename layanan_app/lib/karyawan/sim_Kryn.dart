...
import 'package:layanan_app/model/karyawan_model/simKryn_model.dart';
...
class simKryn extends StatefulWidget {
  final status;
  simKryn({this.status});

  @override
  State<simKryn> createState() => _simKrynState();
}

class _simKrynState extends State<simKryn> {
  @override
  void initState() {
    super.initState();
    _loadReceivedData();
  ...
  Container _menuItems(simKrynModel simKrynModel) {
    return Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: Image.asset(
              'assets/menuImage/${simKrynModel.image}',
              width: 110,
              height: 110,
            ),
          ),
